...
export class SuperJsonPanel {
  public static currentPanel: SuperJsonPanel | undefined;
  private static readonly viewType = 'superJsonEditor';
  ...
  public static createOrShow(
    ...
    SuperJsonPanel.currentPanel = new SuperJsonPanel(
      panel,
      extensionUri,
      initialContent
    );
  ...
  public sendParseContent(content: string): void {
  ...
  private handleRequestParse(): void {
  ...
  private applyToActiveEditor(content: string): void {
    const editor = vscode.window.activeTextEditor;
    if (editor) {
